  ...
  return (
    ...
    >
      <div className="flex gap-3">
        <span className="type-mono-meta w-10 flex-shrink-0 pt-0.5 text-xs text-muted-foreground">
          {publication.year}
        </span>
        <span className="min-w-0">
          ...
          <span className="type-mono-meta mt-1 flex flex-wrap gap-x-3 text-xs text-muted-foreground">
